        ...
        return (
            <>
                <Background img={`${IMG_URL}${movie.details.backdrop_path}`}>
                    <div className="md:flex justify-start mt-20 md:mt-24 h-fit px-2 md:px-0">
                        <img
                            src={`${poster_path}`}
                            alt="poster"
                            className="rounded-lg w-52 h-80 sm:w-64 sm:h-96 shadow-md shadow-white mx-auto md:mx-10 max-h-96"
                        />
                        <div className="md:p-5 py-3 text-white max-w-2xl mt-3">
                    ...
                    <SlidingWindow movies={movie.related} title={"You may also like"} className={''} />
                </Background>
            </>
        );
    }
