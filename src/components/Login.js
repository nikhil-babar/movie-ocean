        ...
        <>
            <div className='text-white text-center w-80 relative bottom-10 md:w-96 backdrop-blur-sm bg-white/20 p-5 rounded-2xl'>
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <p className='my-2'>Don't have an account? <Link to='/signup' className="text-blue-500">sign in</Link></p>
                ...
                <button type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2" onClick={handleGoogleSignIn}>
